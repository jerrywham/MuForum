...
'LANGUAGE'=>"Language",
'PLUGIN'=>"Plugin",
'CONFIG_GZIP'=> 'Enable GZIP compression',
...
'DEFAULT_SUB'=>'Forum without Database',
...
'CHANGE_SECURITY_SALT' => 'You should change security salt string in index.php file',
...
'DEL_THIS_FILE' => 'Delete this file',
'NEW_TOPIC'=>"New Topic",
'ANSWER'=>"Reply",
'CHANGE'=>"Edit",
'TO'=>'on',
...
'WINDOW'=>"Window",
'AUTHOR' => 'Author',
'TXT_REPLACEMENT' => 'Texte of remplacement',
'URL' => 'URL',
'SRC' => 'Source',
'LEVEL' => 'Title level (from 1 to 4) ?',
'WHO' => 'Who quote ?',
'LINK_ADDRESS' => 'Url of link ?',
'LINK_PICTURE' => 'Source of picture ?',
'LINK_VIDEO' => 'Source of video (exemple = //youtu.be/dkfjOS) ?',
'LOGOUT'=>"Logout",
'LOGIN'=>"Login",
'VIEW'=>"Display",
'SEARCH'=>"Search",
...
'MKTHEME' => "Create the themes directory",
...
'MSG_FILE_DEL' => 'successfully deleted file',
'MSG_COME_BACK_IN' => 'Come back in',
'MSG_MIN_OR_NOT' => 'minutes or not...',
'MSG_IF_NOT_SPAMMER' => 'If you are not a robot',
'CLICK_HERE' => 'click here',
'ERROR' => 'Error',
'ERROR_MKTHEME' => "Failed to create the themes directory",
...
'L_ERR_WRONG_PASSWORD' => "Wrong password",
...
'ERROR_INVALID_BIRTHDAY' => 'Invalid date format for Birthday',
'DAY'=>"Day",
'HOUR'=>"time",
'MINUTE'=>"minute",
'SECOND'=>"second",
